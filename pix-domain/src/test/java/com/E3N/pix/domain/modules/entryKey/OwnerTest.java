...
import com.E3N.pix.domain.mocks.domain.EntryKeyMock;
...
public class OwnerTest extends UnitTest {
    ...
    public void givenValidNaturalPerson_shouldReturnOwner(
        ...
        var result = Owner.getInstanceNaturalPerson(name, taxIdNumber, type, account);
    ...
    static Stream<Arguments> providerInvalidNaturalPerson() {
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        "74427945562",
                        TypePerson.NATURAL_PERSON,
                        AccountMock.getRandomAccountWithSpecificEntryKey(EntryKeyMock.getEntryKeyCnpj(RandomKeys.randomInvalidEmails()))),
                Arguments.of(
                        "An",
                        "75628144657",
                        TypePerson.NATURAL_PERSON,
                        AccountMock.getRandomAccountWithSpecificEntryKey(EntryKeyMock.getEntryKeyCnpj(RandomKeys.randomInvalidNaturalPersonDocuments())))
        );
    }
    ...
    public void givenValidLegalPerson_shouldReturnOwner(
        ...
        var result = Owner.getInstanceLegalPerson(name, taxIdNumber, name, type, account);
        Assertions.assertInstanceOf(Owner.class, result);
        Assertions.assertEquals(name, result.getName().getName());
        Assertions.assertEquals(taxIdNumber, result.getTaxIdNumber().getTaxIdNumber());
        Assertions.assertEquals(type, result.getType());
